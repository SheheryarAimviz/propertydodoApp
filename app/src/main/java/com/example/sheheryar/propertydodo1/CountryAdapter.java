...
public class CountryAdapter extends ArrayAdapter<Country> {
    ...
    public CountryAdapter(Context context, int resource, int textViewResourceId, List<Country> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            view = inflater.inflate(R.layout.countrylistview, parent, false);
        }
        Country country = items.get(position);
        if (country != null) {
            TextView lblName = (TextView) view.findViewById(R.id.lbl_name);
            TextView lblLastName = (TextView) view.findViewById(R.id.lbl_last_name);
            if (lblName != null)
                lblName.setText(country.getName());
            if (lblLastName != null)
                lblLastName.setText(country.getlastName());
        }
        return view;
    }
